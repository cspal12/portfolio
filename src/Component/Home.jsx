...
import HeroImage from "../assets/chander.jpeg";
      ...
      >
        <div className="flex flex-col justify-center h-full">
          <h2 className="text-4xl sm:text-7xl font-bold text-white">
            I'm Jr.QA Engineer ensuring flawless user experiences 
          </h2>
          ...
          <div>
            ...
            rounded-md bg-gradient-to-r from-cyan-600 to to-blue-500 cursor-pointer"
            >
              Portfolio
